...
class AppColors {
  static const Color btnBrown = Color(0xFFC67C4E);
  static const Color starYellow = Color(0xFFFBBE21);
  static const Color backgroundBlack = Color(0xFF1B1B1B);
  ...
  static const Color backgroundGradient = Color(0xFF131313);
